...
public class MainPage extends BrowserSettings {
    ...
    public void openSetUpPage() {
        setTotalResultMessage(getTotalResultMessage() + "Open 'application.selenium.settings' page\n");
        driver.findElement(setupButtonLocator).click();
        driver.findElement(settingsButtonLocator).click();
        final Wait<WebDriver> wait = new WebDriverWait(driver, timeoutVariable).withMessage("'Basic application.selenium.settings' page popup was not found");
        ...
        Assert.assertEquals(element.isDisplayed(), true, "'Basic application.selenium.settings' page title was not found");
        Assert.assertEquals(element2.isDisplayed(), true, "'Basic application.selenium.settings' page was not loaded");
        ProgressBar.addProgressValue(progressVariable);
    }
