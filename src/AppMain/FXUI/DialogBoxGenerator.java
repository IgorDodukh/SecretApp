...
import AppMain.Selenium.Settings.UpdateConfig;
...
import static AppMain.FXUI.Controller.getSelectedResourceValue;
import static AppMain.Selenium.Settings.GetPropertyValues.getTimeoutProperty;
...
//            }
    ...
    static void aboutPopupBox() throws MalformedURLException {
        ...
        String newChanges =
                " - AppMain.API mode is added:\n" +
                "   - GET and POST requests are supported for now\n" +
                "   - UI is slightly changed in AppMain.API mode\n" +
