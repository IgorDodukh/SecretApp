...
import AppMain.API.Tests.AuthResource.AuthPOST;
import AppMain.Selenium.Settings.BrowserSettings;
import AppMain.Selenium.Settings.ReadConfigMain;
...
import static AppMain.FXUI.ComboBoxesHandler.additionalDialogDeterminer;
import static AppMain.FXUI.DialogBoxGenerator.*;
import static AppMain.FXUI.ExecutionTimeCounter.startCounter;
import static AppMain.FXUI.ExecutionTimeCounter.stopCounter;
import static AppMain.FXUI.InternetConnection.getFailedContentText;
import static AppMain.Selenium.Settings.GetPropertyValues.loginProperty;
import static AppMain.Selenium.Settings.GetPropertyValues.passProperty;
import static AppMain.Selenium.Settings.UpdateConfig.updateCredentials;
...
//            apiEnvironment.textProperty().setValue(environmentComboBoxValue);
            ...
            if (internetConnection.checkInternetConnection()) {
                ...
                failedPopupBox(getFailedContentText() + "\nAppMain.API mode can't be used without Internet connection.");
